...
This Environment [Template](https://documentation.bunnyshell.com/docs/templates-what-are-templates) is a boilerplate for creating a new environment based on a stack using PHP with Symfony for the backend, Angular with Typescript for the frontend and MySQL as the database.
