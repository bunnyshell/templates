...
This Environment [Template](https://documentation.bunnyshell.com/docs/templates-what-are-templates) is a boilerplate for creating a new environment based on a stack using **Node.js** with Express for the backend, **React** with Typescript for the frontend and an **AWS RDS PostgreSQL** as the database.
...
In order to create the AWS RDS instance, you will need to fill in the AWS credentials:
- `AWS_ACCESS_KEY_ID`
